...
const buttonBaseStyle =
  "flex justify-center items-center gap-8 rounded-6 duration-200 font-normal focus:outline-none whitespace-nowrap";
...
> = {
  ...
  secondary: {
    ...
    ghost:
      "hover:bg-gray-100 active:bg-gray-200 dark:active:bg-gray-900 disabled:!bg-transparent dark:hover:bg-gray-800",
    outlined:
